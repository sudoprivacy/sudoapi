...
const sOpts = computed(() => [{ value: '', label: t('admin.accounts.allStatus') }, { value: 'active', label: t('admin.accounts.status.active') }, { value: 'inactive', label: t('admin.accounts.status.inactive') }, { value: 'error', label: t('admin.accounts.status.error') }, { value: 'rate_limited', label: t('admin.accounts.status.rateLimited') }, { value: 'temp_unschedulable', label: t('admin.accounts.status.tempUnschedulable') }, { value: 'unschedulable', label: t('admin.accounts.status.unschedulable') }, { value: 'review_pending', label: t('admin.accounts.reviewFilters.pending') }, { value: 'review_approved', label: t('admin.accounts.reviewFilters.approved') }, { value: 'review_rejected', label: t('admin.accounts.reviewFilters.rejected') }, { value: 'external', label: t('admin.accounts.reviewFilters.external') }])
