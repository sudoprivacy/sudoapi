export default {
  ...
  home: {
    ...
    heroSubtitle: "Unified access for AI workloads",
    heroDescription:
      "A stable, observable gateway for teams and applications, with centralized keys, billing, and routing",
    tags: {
      subscriptionToApi: "Unified Gateway",
    ...
    features: {
      ...
      unifiedGatewayDesc:
        "Connect configured AI models through one managed entry point and reduce integration overhead.",
      multiAccount: "Always Reliable",
      multiAccountDesc:
        "Route requests by availability and policy to reduce the impact of single-channel failures.",
  ...
  // Setup Wizard
  setup: {
    title: "SudoRouter Setup",
    description: "Configure your SudoRouter instance",
    database: {
  ...
  modelSquare: {
    ...
    detail: {
      ...
      groupPricesHint:
        "Prices already include the effective multiplier (base × user).",
  ...
  liteLLMModels: {
    title: "Model Square",
    subtitle: "Browse the model catalog, capabilities, and reference pricing",
    searchPlaceholder: "Search models, providers, types, capabilities...",
    empty: "No models match your filters",
    resultCount: "Showing {count} of {total} models",
    lastLoaded: "Loaded at {time}",
    loadFailed: "Failed to load models: {msg}",
    filters: {
      allProviders: "All providers",
      allModes: "All types",
    },
    ...
    sort: {
      latestDesc: "Newest first",
      nameAsc: "Model A-Z",
      nameDesc: "Model Z-A",
      providerAsc: "Provider A-Z",
      modeAsc: "Type A-Z",
      inputAsc: "Input low-high",
      inputDesc: "Input high-low",
      outputAsc: "Output low-high",
      outputDesc: "Output high-low",
      contextDesc: "Context long-short",
    },
    columns: {
      model: "Model",
    ...
    detail: {
      ...
      inputPrice: "Input",
      inputPriorityPrice: "Priority input",
      outputPrice: "Output",
      outputPriorityPrice: "Priority output",
      cacheWritePrice: "Cache write 5m",
      cacheWrite1hPrice: "Cache write 1h",
      cacheReadPrice: "Cache read",
      cacheReadPriorityPrice: "Priority cache read",
      imagePrice: "Image",
      imageTokenPrice: "Image output token",
    ...
    pricingSections: {
      token: "Token pricing",
      cache: "Cache pricing",
      serviceTier: "Priority / Flex pricing",
      multimodal: "Multimodal pricing",
      batchAndText: "Batch, character, and search pricing",
      longContext: "Long-context rules",
    },
    pricingLabels: {
      inputAbove128k: "Input above 128K tokens",
      outputAbove128k: "Output above 128K tokens",
      inputAbove200k: "Input above 200K tokens",
      outputAbove200k: "Output above 200K tokens",
      cacheWriteAbove200k: "Cache write above 200K tokens",
      cacheReadAbove200k: "Cache read above 200K tokens",
      audioCacheWrite: "Audio cache write",
      audioCacheRead: "Audio cache read",
      imageCacheRead: "Image cache read",
      priorityAudioInput: "Priority audio input",
      priorityInputAbove200k: "Priority input above 200K tokens",
      priorityOutputAbove200k: "Priority output above 200K tokens",
      priorityCacheReadAbove200k: "Priority cache read above 200K tokens",
      flexInput: "Flex input",
      flexOutput: "Flex output",
      flexCacheRead: "Flex cache read",
      imageInput: "Image input",
      imageInputAbove128k: "Image input above 128K tokens",
      imageInputToken: "Image input token",
      audioInputToken: "Audio input token",
      audioOutputToken: "Audio output token",
      audioInputSecond: "Audio input duration",
      audioInputSecondAbove128k: "Audio input duration above 128K tokens",
      videoInputSecond: "Video input duration",
      videoInputSecondAbove128k: "Video input duration above 128K tokens",
      outputSecond: "Output duration",
      batchInput: "Batch input",
      batchOutput: "Batch output",
      characterInput: "Character input",
      characterOutput: "Character output",
      characterInputAbove128k: "Character input above 128K tokens",
      characterOutputAbove128k: "Character output above 128K tokens",
      searchContext: "Search context query",
    },
  },
  ...
  contributor: {
    accounts: {
      ...
      description:
        "Add and maintain model accounts you submitted. They are scheduled only after admin approval.",
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2:
            'Click "Create bucket", enter a name (e.g. sudorouter-backups), choose a region',
    ...
    users: {
      ...
      batch: {
        ...
        columnsHint:
          "Supports comma / semicolon / tab. Header row is optional. Lines starting with # are ignored.",
        securityNotice:
          "Use a trusted network. The CSV contains plaintext passwords; they are not written to logs.",
    ...
    channels: {
      ...
      endpointConfig: {
        ...
        description:
          "Rules are global per platform. Unmatched model types show no endpoints.",
        ...
        invalidKey:
          "Platform and model type may only contain lowercase letters, numbers, underscores, and hyphens.",
    ...
    modelMetadata: {
      ...
      noModelsDesc:
        "No displayable models are currently available from active channels",
      ...
      form: {
        ...
        capabilitiesHint:
          "Selected capabilities override automatic inference. Leave empty to keep automatic data.",
        modalitiesHint: "Leave empty to keep LiteLLM automatic data.",
        supportFlagsHint:
          "Model tags come from all true LiteLLM supports_* fields. Leave empty to keep automatic data.",
    ...
    accounts: {
      ...
      dataImportResultSummary:
        "Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, skipped {account_skipped}, failed {account_failed}",
      dataImportErrors: "Error Details",
      dataImportSuccess:
        "Import completed: accounts created {account_created}, skipped {account_skipped}, failed {account_failed}",
      dataImportCompletedWithErrors:
        "Import completed with errors: account skipped {account_skipped}, account failed {account_failed}, proxy failed {proxy_failed}",
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description:
          "Configure LinuxDo Connect OAuth for SudoRouter end-user login",
      ...
      site: {
        ...
        siteName: "Site Name",
        siteNamePlaceholder: "SudoRouter",
        siteNameHint: "Displayed in emails and page titles",
        siteSubtitle: "Site Subtitle",
        siteSubtitlePlaceholder: "Stable AI Gateway for Teams",
      ...
      payment: {
        ...
        field_fuiouApiBaseHint:
          "Use https://hlwnets.fuioupay.com for production and https://hlwnets-test.fuioupay.com for sandbox/test. The base must match the environment your API keys were issued for.",
        fuiouGuideSummary:
          "Fuiou aggregate payment: accept Alipay and WeChat Pay through a single merchant account.",
        fuiouGuideNote:
          "The merchant private key must be PKCS8 + Base64; the Fuiou public key is the PKIX + Base64 key downloaded from the Fuiou merchant portal. mchnt_cd is also used to route async callbacks, so it must match your Fuiou contract / portal value exactly.",
      ...
      smtp: {
        ...
        fromName: "From Name",
        fromNamePlaceholder: "SudoRouter",
        useTls: "Use TLS",
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: "👋 Welcome to SudoRouter",
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the SudoRouter AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: "Start 🚀",
        prevBtn: "Skip",
      },
      keyManage: {
