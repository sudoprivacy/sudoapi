export default {
  ...
  home: {
    ...
    heroDescription: 'A stable, observable gateway for teams and applications, with centralized keys, billing, and routing',
    tags: {
    ...
    features: {
      ...
      unifiedGatewayDesc: 'Connect configured AI models through one managed entry point and reduce integration overhead.',
      multiAccount: 'Always Reliable',
      multiAccountDesc: 'Route requests by availability and policy to reduce the impact of single-channel failures.',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: 'Click "Create bucket", enter a name (e.g. sudorouter-backups), choose a region',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SudoRouter end-user login',
