export default {
  ...
  home: {
    ...
    heroDescription: '为团队和应用提供稳定、可观测的模型访问入口，简化密钥、计费与路由管理',
    tags: {
    ...
    features: {
      unifiedGateway: '一键接入',
      unifiedGatewayDesc: '通过统一入口接入已配置的 AI 模型，降低多平台对接和维护成本。',
      multiAccount: '稳定可靠',
      multiAccountDesc: '根据可用性和策略自动选择上游通道，减少单点故障对业务的影响。',
      balanceQuota: '用多少付多少',
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 sudorouter-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
