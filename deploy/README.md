# SudoRouter Deployment Files

This directory contains files for deploying SudoRouter on Linux servers.
...
SudoRouter supports three methods to connect to Gemini:
...
SudoRouter supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
